...
suspend fun updateMemberRole(ctx: ApiContext) {
    ...
    transaction {
        ...
        val updated = WorkspaceMembers.update({
        ...
        if (updated == 0) ctx.respondError(404, "Member not found")
        else ctx.respondJson(200, apiJson.encodeToString(SuccessResponse("Role updated")))
    }
}
